    ...
    ko: {
        ...
        contents: {
            ...
            "exam-scope": `
                ...
                <ul>
                    <li>3.1. 시험에 출제되는 문항 수는 문제 은행에서 출제 범위 내에 있는 문제들의 수를 넘을 수 없다.</li>
                    <li>3.2. 시험에 출제되는 문항 수는 문제 은행에서 출제 범위 내에 있는 문제들이 속한 그룹들의 수를 넘을 수 없다.</li>
        ...
        contents: {
            ...
            "qbank-editing": `
                ...
                <ul>
                    ...
                    <li>2.10. Кнопка <strong>->V<- Вставить вариант</strong>: Вставляет пустой вариант между номерами вариантов, введёнными в двух полях слева от неё.</li>
        ...
        contents: {
            "qbank-structure": `
                ...
                <ul>
                    ...
                    <li>1.2.6. <strong>Кыска жооп</strong>: Эгер сиз «В варианты» деп киргизсеңиз, ал суроо номеринин алдында «[В варианты]» деп басылып чыгат. Бул студентке суроо В түрүнө кирерин билдирет. Бош калтырсаңыз, жөн га나 кашаалар [ ] пайда болот.</li>
                    <li>1.2.7. <strong>Кеңири жооп</strong>: Эгер сиз «Г варианты» деп киргизсеңиз, ал суроо номери의 алдында «[Г варианты]» деп басылып чыгат. Бул студентке суроо Г түрүнө кирерин билдирет. Бош калтырсаңыз, жөн гана кашаалар [ ] пайда болот.</li>
                    <li>1.2.8. <strong>Эскертүү</strong>: Сынактын эрежелери. Экзамен өткөрүү эреже레рин киргизиңиз. Аты-жөнү жана ID аталыштын астында көрсөтүлөт, андан кийин эскертүү мазмуну келет, андан соң суроолор башталат. Эгерде өзгөчө эч нерсе кошуунун кереги жок болсо, жөн гана «Ийгилик!» деп жазсаңыз болот.</li>
                </ul>
                <p>1.3. <strong>Демейки мазмун</strong> баскычы: Бул баскычты басуу «Баш сөздөн» тышкары бардык талааларды тандалган «Тилге» жараша алдын ала сакталган мазмун менен автоматтык түрдө толтурат. Кол도нуучулар керектүү бөлүктөрүн гана өзгөртө алышат. «Эскертүү» бөлүмү кол도нуучу тандаган «Баалоо эрежесине» жана «Тилге» жараша суроо түрлөрүнүн сүрөттөлүшү жана баалоо эрежелери менен автоматтык түрдө толтурулат.</p>
                <h3>2. Суроолор</h3>
                <p>2.1. Суроолордун төрт түрү колдооo алынат: <strong>Бир жооптуу тест</strong>, <strong>Бир нече жооптуу тест</strong>, <strong>Кыска жооп</strong> жана <strong>Кеңири жооп</strong>. Учурда шайкештикти текшерүүчү суроолор колдооo алынбайт. «Туура/Ката» түрүндөгү суроолорду эки варианттуу тест катары ишке ашырса болот.</p>
                <ul>
                ...
                <ul>
                    ...
                    <li>2.2.3. <strong>Суроо тексти</strong>: Суроонун өзүнүн тексти. Бир нече сапты киргизүүгө болот, бирок учурда сүрөттөр колдооo алынбайт.</li>
            ...
            "qbank-usage": `
                ...
                <ul>
                    ...
                    <li>2.3. Суроолордун төрт түрү (<strong>Бир жооптуу тест</strong>, <strong>Бир нече жооптуу тест</strong>, <strong>Кыска жооп</strong> жана <strong>Кеңири жооп</strong>) боюнча статистика суроолор банкын системалуу башкарууга жар담 берет.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>3.2. <strong>Кеңири жооптуу тапшырмалар</strong> үчүн үлгүлүү жооптор берилет. Мындай тапшырмалар өз алдынча окууну автоматташтырылган баалоодон чыгарылса да, үлгүлүү жооптор окутуучуларга кол менен текшерүүдө ырааттуулукту сактоого жардам берет.</li>
                ...
                <ul>
                    ...
                    <li>4.3. Эгерде студенттер кыйналып жатышса, окутуучу суроолор банкынын файлын бөлүшө алат. Андан кийин студенттер өз компьютерлеринде QuizWizдин өз алдынча окуу функциясын колдонуп машыгып, жакшы окуу көндүмдөрүн калыптандыра алышат.</li>
                </ul>
            `,
            "exam-random": `
                <h3>1. Суроолор банкынан экзамен суроолорун алуу</h3>
                <ul>
                    <li>1.1. <strong>Экзамендин чөйрөсү</strong>: Суроолор банкындагы суроо номерлеринин диапазону менен аныкталат.</li>
            ...
            "exam-scope": `
                ...
                <ul>
                    ...
                    <li>1.2. Экзамендин чөйрөсү «суроолор банкындагы X-суроодон Y-суроого чейин» деген форматта аныкталат.</li>
                ...
                <ul>
                    ...
                    <li>2.2. Экзамендин чөйрөсүнүн форматы — суроолор банкындагы X-суроодон Y-суроого чейин.</li>
                ...
                <ul>
                    <li>3.1. Экзамендеги суроолордун саны суроолор банкындагы белгиленген чөйрөдөгү суроолордун жалпы санынан ашпоого тийиш.</li>
            ...
            "students-editing": `
                ...
                <ul>
                    <li>1.1. <strong>Аты-жөнү</strong>: Студенттин толук аты-жөнү. Фамилиясы, аты жана атасынын аты (эгер бар болсо) чогуу киргизилет. Ар кандай маданияттарда жана этникалык топтордо ысымдарды коюу салты ар башка болгондуктан, студенттерди башкарууга караганда суроолор банкын башкарууга багытталган бул колдонмо үчүн ысымдын бөлүктөрүн бөлүп отурбоо ыңгайлуураак.</li>
                    <li>1.2. <strong>Студенттик билет номери</strong>: Цифраларды да, тамгаларды да киргизүүгө болот.</li>
                ...
                <ul>
                    ...
                    <li>2.3. <strong>Белгилөө кутучасы</strong>: Белгилөө кутучасын басканда белги пайда болуп, студент тандалганын билдирет. Аны кайра бассаңыз, белги жоголуп, студент тандоодон чыгарылганын билдирет.</li>
