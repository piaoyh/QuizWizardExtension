...
class QuizWizardApp {
    ...
    /** 문제은행 작업공간 초기화 */
    initializeQuestionBankWorkspace() {
        if (!this.container)
            return;
    ...
    async openQuestionBank() {
        try {
            ...
            // 4. 주인님이 만든 Wasm 엔진에 buffer(Uint8Array) 넘기기
    ...
    /* 학생 명단 관련 함수군 */
    openStudentList() { console.log("openStudentList() 호출됨"); }
    ...
    setLanguage() {
        ...
        this.currentLang = langs[nextIdx]; // Type Assertion 적용
